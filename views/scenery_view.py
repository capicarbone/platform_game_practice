...
class SceneryView(object):
    def __init__(self):
        ...
        self.tiles_images['4'] = pygame.transform.flip(self.tiles_images['3'], True, False)
        self.tiles_images['8'] = pygame.image.load(ASSETS_FOLDER + 'tiles/grass_right.png')
        self.tiles_images['5'] = pygame.transform.flip(self.tiles_images['8'], True, False)
        self.tiles_images['9'] = pygame.transform.flip(self.tiles_images['2'], False, True)
        ...
        self.tiles_images['12'] = pygame.transform.flip(self.tiles_images['11'], True, False)
